...
When all 3 happen the order of access is nondeterministic and leads to the corruption of the data...

Some data-races may be intentional (benign) like busy-wait construct...
